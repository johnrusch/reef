...
**Plans:** 2/2 plans complete
Plans:
- [x] 22-01-PLAN.md — PanelGroup resize layout, sidebar highlight fix, breadcrumb level suffix
- [x] 22-02-PLAN.md — Element tree in sidebar via IPC extraction from .reef/ .puml files
**UI hint**: yes
...
**Plans:** 2 plans
Plans:
- [ ] 23-01-PLAN.md — Extend static analyzer with function parameters and enum extraction
...
| 23. Code-Level Diagram Quality | v1.5 | 0/2 | Not started | - |
